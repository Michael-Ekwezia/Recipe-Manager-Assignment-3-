...
A Java console application that manages bread recipes, allows users to place bread orders, and generates a shopping list based on ingredient requirements.  
This project was created as part of CST8284 – Object-Oriented Programming.
...
* Run `RecipeManagerTest.java` using **Run As → JUnit Test**
